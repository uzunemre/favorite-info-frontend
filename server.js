...
app.use(express.static(path.join(__dirname, 'favorite/build')));
...
if (process.env.NODE_ENV === 'production') {
    ...
    app.use(express.static(path.join(__dirname, 'favorite/build')));
    app.get('*', (req, res) => {
        res.sendfile(path.join(__dirname = 'favorite/build/index.html'));
    })
}
...
app.get('*', (req, res) => {
    res.sendFile(path.join(__dirname + '/favorite/public/index.html'));
});
